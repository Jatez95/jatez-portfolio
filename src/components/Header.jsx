...
export default function Header() {
    return (
        <header className='lg:w-full md:w-full sm:w-full lg:h-1/5 md:h-1/5 sm:h-1/5 mt-32 flex flex-col justify-center items-center text-center px-4'>
            <h1 className='text-3xl md:text-5xl bg-gradient-to-r from-neutral-50 to-neutral-500 text-transparent bg-clip-text font-bold uppercase'>
                Full Stack Developer
            </h1>
            <p className='bg-gradient-to-r from-neutral-50 to-neutral-500 text-transparent bg-clip-text tracking-widest mt-3 lg:text-lg md:text-md'>
